	...
	*/
	...
	public void testRegister() throws Exception {
		...
		String resultPage = mockMvc
				...
				.param("title", "?Öå?ä§?ä∏ ?ÉàÍ∏? ?†úÎ™?")
				.param("content", "?Öå?ä§?ä∏ ?ÉàÍ∏? ?Ç¥?ö©")
				.param("writer", "user00"))
	...
	public void testModify() throws Exception {
		...
		String resultPage = mockMvc
				.perform(MockMvcRequestBuilders.post("/board/modify").param("bno", "1").param("title", "?àò?†ï?êú ?Öå?ä§?ä∏ ?ÉàÍ∏? ?†úÎ™?")
						.param("content", "?àò?†ï?êú ?Öå?ä§?ä∏ ?ÉàÍ∏? ?Ç¥?ö©").param("writer", "user00"))
				.andReturn().getModelAndView().getViewName();
	...
	public void testRemove() throws Exception {
		// ?Ç≠?†ú?†Ñ ?ç∞?ù¥?Ñ∞Î≤†Ïù¥?ä§?óê Í≤åÏãúÎ¨? Î≤àÌò∏ ?ôï?ù∏?ï† Í≤?
